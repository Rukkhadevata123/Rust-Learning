...
use burn::{
    nn::{self, BatchNorm, PaddingConfig2d, conv::Conv2d, loss::CrossEntropyLossConfig},
    prelude::*,
...
impl<B: Backend> Model<B> {
    pub fn new(device: &B::Device) -> Self {
        let conv1 = ConvBlock::new([1, 8], [3, 3], device);
        let conv2 = ConvBlock::new([8, 16], [3, 3], device);
        let conv3 = ConvBlock::new([16, 24], [3, 3], device);
